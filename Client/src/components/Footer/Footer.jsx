        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-500 max-w-sm text-sm leading-relaxed uppercase tracking-wider">
              The ultimate deployment platform for street footballers and
              professional athletes. High-spec turfs, zero friction booking.
            </p>
          </div>

          {/* quick links */}
          <div className="space-y-4">
            <h4 className="text-xs font-black text-lime-400 uppercase tracking-[0.3em]">
              Navigation
            </h4>
